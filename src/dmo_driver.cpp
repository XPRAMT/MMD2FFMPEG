...
const TabUiStrings& tab_ui_strings(UiLanguage language) {
    static constexpr TabUiStrings traditional{L"影片", L"音訊", L"設定", L"音訊格式", L"取樣率/位元深度", L"影片編碼完成後,自動讀取AVI內含音訊,合併進MKV檔案,花費時間取決於硬碟速度。", L"原始", L"Hi-Res", L"如果原始取樣率小於48KHz，Hi-Res模式以原始取樣率2倍及24bit編碼，以通過 bilibili Hi-Res 判定。", L"版本", L"作者", L"GitHub"};
    static constexpr TabUiStrings simplified{L"视频", L"音频", L"设置", L"音频格式", L"采样率/位深度", L"视频编码完成后,自动读取AVI内含音频,合并进MKV文件,耗时取决于硬盘速度。", L"原始", L"Hi-Res", L"如果原始采样率小于48KHz，Hi-Res模式以原始采样率2倍及24bit编码，以通过 bilibili Hi-Res 判定。", L"版本", L"作者", L"GitHub"};
